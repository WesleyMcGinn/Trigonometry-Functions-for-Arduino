...
// Inverse of tangent:
double i_Tan(double m) {
  double n = ((round(m*1000))/(1000));
  if (n < -50) { return -90.0; }
  if (n > 50) { return 90.0; }
  if (n > -50.5 && n <= -49.5) { return -88.854; }
  if (n > -49.5 && n <= -48.5) { return -88.831; }
  if (n > -48.5 && n <= -47.5) { return -88.807; }
  if (n > -47.5 && n <= -46.5) { return -88.781; }
  if (n > -46.5 && n <= -45.5) { return -88.755; }
  if (n > -45.5 && n <= -44.5) { return -88.727; }
  if (n > -44.5 && n <= -43.5) { return -88.698; }
  if (n > -43.5 && n <= -42.5) { return -88.668; }
  if (n > -42.5 && n <= -41.5) { return -88.636; }
  if (n > -41.5 && n <= -40.5) { return -88.603; }
  if (n > -40.5 && n <= -39.5) { return -88.568; }
  if (n > -39.5 && n <= -38.5) { return -88.531; }
  if (n > -38.5 && n <= -37.5) { return -88.493; }
  if (n > -37.5 && n <= -36.5) { return -88.452; }
  if (n > -36.5 && n <= -35.5) { return -88.409; }
  if (n > -35.5 && n <= -34.5) { return -88.363; }
  if (n > -34.5 && n <= -33.5) { return -88.315; }
  if (n > -33.5 && n <= -32.5) { return -88.264; }
  if (n > -32.5 && n <= -31.5) { return -88.21; }
  if (n > -31.5 && n <= -30.5) { return -88.152; }
  if (n > -30.5 && n <= -29.5) { return -88.091; }
  if (n > -29.5 && n <= -28.5) { return -88.025; }
  if (n > -28.5 && n <= -27.5) { return -87.955; }
  if (n > -27.5 && n <= -26.5) { return -87.879; }
  if (n > -26.5 && n <= -25.5) { return -87.797; }
  if (n > -25.5 && n <= -24.5) { return -87.709; }
  if (n > -24.5 && n <= -23.5) { return -87.614; }
  if (n > -23.5 && n <= -22.5) { return -87.51; }
  if (n > -22.5 && n <= -21.5) { return -87.397; }
  if (n > -21.5 && n <= -20.5) { return -87.274; }
  if (n > -20.5 && n <= -19.5) { return -87.138; }
  if (n > -19.5 && n <= -18.5) { return -86.987; }
  if (n > -18.5 && n <= -17.5) { return -86.82; }
  if (n > -17.5 && n <= -16.5) { return -86.634; }
  if (n > -16.5 && n <= -15.5) { return -86.424; }
  if (n > -15.5 && n <= -14.5) { return -86.186; }
  if (n > -14.5 && n <= -13.5) { return -85.914; }
  if (n > -13.5 && n <= -12.5) { return -85.601; }
  if (n > -12.5 && n <= -11.5) { return -85.236; }
  if (n > -11.5 && n <= -10.5) { return -84.806; }
  if (n > -10.5 && n <= -9.5) { return -84.289; }
  if (n > -9.5 && n <= -8.5) { return -83.66; }
  if (n > -8.5 && n <= -7.5) { return -82.875; }
  if (n > -7.5 && n <= -6.5) { return -81.87; }
  if (n > -6.5 && n <= -5.5) { return -80.538; }
  if (n > -5.5 && n <= -4.5) { return -78.69; }
  if (n > -4.5 && n <= -3.5) { return -75.964; }
  if (n > -3.5 && n <= -2.5) { return -71.565; }
  if (n > -2.025 && n <= -1.975) { return -63.435; }
  if (n > -1.975 && n <= -1.925) { return -62.85; }
  if (n > -1.925 && n <= -1.875) { return -62.241; }
  if (n > -1.875 && n <= -1.825) { return -61.607; }
  if (n > -1.825 && n <= -1.775) { return -60.945; }
  if (n > -1.775 && n <= -1.725) { return -60.255; }
  if (n > -1.725 && n <= -1.675) { return -59.534; }
  if (n > -1.675 && n <= -1.625) { return -58.782; }
  if (n > -1.625 && n <= -1.575) { return -57.995; }
  if (n > -1.575 && n <= -1.525) { return -57.171; }
  if (n > -1.525 && n <= -1.475) { return -56.31; }
  if (n > -1.475 && n <= -1.425) { return -55.408; }
  if (n > -1.425 && n <= -1.375) { return -54.462; }
  if (n > -1.375 && n <= -1.325) { return -53.471; }
  if (n > -1.325 && n <= -1.275) { return -52.431; }
  if (n > -1.275 && n <= -1.225) { return -51.34; }
  if (n > -1.225 && n <= -1.175) { return -50.194; }
  if (n > -1.175 && n <= -1.125) { return -48.991; }
  if (n > -1.125 && n <= -1.075) { return -47.726; }
  if (n > -1.075 && n <= -1.025) { return -46.397; }
  if (n > -1.025 && n <= -0.975) { return -45.0; }
  if (n > -0.975 && n <= -0.925) { return -43.531; }
  if (n > -0.925 && n <= -0.875) { return -41.987; }
  if (n > -0.875 && n <= -0.825) { return -40.365; }
  if (n > -0.825 && n <= -0.775) { return -38.66; }
  if (n > -0.775 && n <= -0.725) { return -36.87; }
  if (n > -0.725 && n <= -0.675) { return -34.992; }
  if (n > -0.675 && n <= -0.625) { return -33.024; }
  if (n > -0.625 && n <= -0.575) { return -30.964; }
  if (n > -0.575 && n <= -0.525) { return -28.811; }
  if (n > -0.525 && n <= -0.475) { return -26.565; }
  if (n > -0.475 && n <= -0.425) { return -24.228; }
  if (n > -0.425 && n <= -0.375) { return -21.801; }
  if (n > -0.375 && n <= -0.325) { return -19.29; }
  if (n > -0.325 && n <= -0.275) { return -16.699; }
  if (n > -0.275 && n <= -0.225) { return -14.036; }
  if (n > -0.225 && n <= -0.175) { return -11.31; }
  if (n > -0.175 && n <= -0.125) { return -8.531; }
  if (n > -0.125 && n <= -0.075) { return -5.711; }
  if (n > -0.075 && n <= -0.025) { return -2.862; }
  if (n > -0.025 && n <= 0.025) { return 0.0; }
  if (n > 0.025 && n <= 0.075) { return 2.862; }
  if (n > 0.075 && n <= 0.125) { return 5.711; }
  if (n > 0.125 && n <= 0.175) { return 8.531; }
  if (n > 0.175 && n <= 0.225) { return 11.31; }
  if (n > 0.225 && n <= 0.275) { return 14.036; }
  if (n > 0.275 && n <= 0.325) { return 16.699; }
  if (n > 0.325 && n <= 0.375) { return 19.29; }
  if (n > 0.375 && n <= 0.425) { return 21.801; }
  if (n > 0.425 && n <= 0.475) { return 24.228; }
  if (n > 0.475 && n <= 0.525) { return 26.565; }
  if (n > 0.525 && n <= 0.575) { return 28.811; }
  if (n > 0.575 && n <= 0.625) { return 30.964; }
  if (n > 0.625 && n <= 0.675) { return 33.024; }
  if (n > 0.675 && n <= 0.725) { return 34.992; }
  if (n > 0.725 && n <= 0.775) { return 36.87; }
  if (n > 0.775 && n <= 0.825) { return 38.66; }
  if (n > 0.825 && n <= 0.875) { return 40.365; }
  if (n > 0.875 && n <= 0.925) { return 41.987; }
  if (n > 0.925 && n <= 0.975) { return 43.531; }
  if (n > 0.975 && n <= 1.025) { return 45.0; }
  if (n > 1.025 && n <= 1.075) { return 46.397; }
  if (n > 1.075 && n <= 1.125) { return 47.726; }
  if (n > 1.125 && n <= 1.175) { return 48.991; }
  if (n > 1.175 && n <= 1.225) { return 50.194; }
  if (n > 1.225 && n <= 1.275) { return 51.34; }
  if (n > 1.275 && n <= 1.325) { return 52.431; }
  if (n > 1.325 && n <= 1.375) { return 53.471; }
  if (n > 1.375 && n <= 1.425) { return 54.462; }
  if (n > 1.425 && n <= 1.475) { return 55.408; }
  if (n > 1.475 && n <= 1.525) { return 56.31; }
  if (n > 1.525 && n <= 1.575) { return 57.171; }
  if (n > 1.575 && n <= 1.625) { return 57.995; }
  if (n > 1.625 && n <= 1.675) { return 58.782; }
  if (n > 1.675 && n <= 1.725) { return 59.534; }
  if (n > 1.725 && n <= 1.775) { return 60.255; }
  if (n > 1.775 && n <= 1.825) { return 60.945; }
  if (n > 1.825 && n <= 1.875) { return 61.607; }
  if (n > 1.875 && n <= 1.925) { return 62.241; }
  if (n > 1.925 && n <= 1.975) { return 62.85; }
  if (n > 1.975 && n <= 2.025) { return 63.435; }
  if (n > 2.025 && n <= 2.075) { return 63.997; }
  if (n > 2.075 && n <= 2.125) { return 64.537; }
  if (n > 2.125 && n <= 2.175) { return 65.056; }
  if (n > 2.175 && n <= 2.225) { return 65.556; }
  if (n > 2.225 && n <= 2.275) { return 66.038; }
  if (n > 2.275 && n <= 2.325) { return 66.501; }
  if (n > 2.325 && n <= 2.375) { return 66.949; }
  if (n > 2.375 && n <= 2.425) { return 67.38; }
  if (n > 2.425 && n <= 2.475) { return 67.797; }
  if (n > 2.475 && n <= 2.525) { return 68.199; }
  if (n > 2.525 && n <= 2.575) { return 68.587; }
  if (n > 2.575 && n <= 2.625) { return 68.962; }
  if (n > 2.625 && n <= 2.675) { return 69.326; }
  if (n > 2.675 && n <= 2.725) { return 69.677; }
  if (n > 2.725 && n <= 2.775) { return 70.017; }
  if (n > 2.775 && n <= 2.825) { return 70.346; }
  if (n > 2.825 && n <= 2.875) { return 70.665; }
  if (n > 2.875 && n <= 2.925) { return 70.974; }
  if (n > 2.925 && n <= 2.975) { return 71.274; }
  if (n > 2.5 && n <= 3.5) { return 71.565; }
  if (n > 3.5 && n <= 4.5) { return 75.964; }
  if (n > 4.5 && n <= 5.5) { return 78.69; }
  if (n > 5.5 && n <= 6.5) { return 80.538; }
  if (n > 6.5 && n <= 7.5) { return 81.87; }
  if (n > 7.5 && n <= 8.5) { return 82.875; }
  if (n > 8.5 && n <= 9.5) { return 83.66; }
  if (n > 9.5 && n <= 10.5) { return 84.289; }
  if (n > 10.5 && n <= 11.5) { return 84.806; }
  if (n > 11.5 && n <= 12.5) { return 85.236; }
  if (n > 12.5 && n <= 13.5) { return 85.601; }
  if (n > 13.5 && n <= 14.5) { return 85.914; }
  if (n > 14.5 && n <= 15.5) { return 86.186; }
  if (n > 15.5 && n <= 16.5) { return 86.424; }
  if (n > 16.5 && n <= 17.5) { return 86.634; }
  if (n > 17.5 && n <= 18.5) { return 86.82; }
  if (n > 18.5 && n <= 19.5) { return 86.987; }
  if (n > 19.5 && n <= 20.5) { return 87.138; }
  if (n > 20.5 && n <= 21.5) { return 87.274; }
  if (n > 21.5 && n <= 22.5) { return 87.397; }
  if (n > 22.5 && n <= 23.5) { return 87.51; }
  if (n > 23.5 && n <= 24.5) { return 87.614; }
  if (n > 24.5 && n <= 25.5) { return 87.709; }
  if (n > 25.5 && n <= 26.5) { return 87.797; }
  if (n > 26.5 && n <= 27.5) { return 87.879; }
  if (n > 27.5 && n <= 28.5) { return 87.955; }
  if (n > 28.5 && n <= 29.5) { return 88.025; }
  if (n > 29.5 && n <= 30.5) { return 88.091; }
  if (n > 30.5 && n <= 31.5) { return 88.152; }
  if (n > 31.5 && n <= 32.5) { return 88.21; }
  if (n > 32.5 && n <= 33.5) { return 88.264; }
  if (n > 33.5 && n <= 34.5) { return 88.315; }
  if (n > 34.5 && n <= 35.5) { return 88.363; }
  if (n > 35.5 && n <= 36.5) { return 88.409; }
  if (n > 36.5 && n <= 37.5) { return 88.452; }
  if (n > 37.5 && n <= 38.5) { return 88.493; }
  if (n > 38.5 && n <= 39.5) { return 88.531; }
  if (n > 39.5 && n <= 40.5) { return 88.568; }
  if (n > 40.5 && n <= 41.5) { return 88.603; }
  if (n > 41.5 && n <= 42.5) { return 88.636; }
  if (n > 42.5 && n <= 43.5) { return 88.668; }
  if (n > 43.5 && n <= 44.5) { return 88.698; }
  if (n > 44.5 && n <= 45.5) { return 88.727; }
  if (n > 45.5 && n <= 46.5) { return 88.755; }
  if (n > 46.5 && n <= 47.5) { return 88.781; }
  if (n > 47.5 && n <= 48.5) { return 88.807; }
